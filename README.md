...
- In a Linux machine, use the version of ImageJ that appears with the default Linux executable icon <img align="right" src="Images/LinuxLogo.png" style="width: 200px;"/>
